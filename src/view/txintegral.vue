<template>
  <div class="page">
    ...
    <div class="footer">
      <div class="title">会员权益介绍</div>
      <div class="icon-list">
        <van-row>
          <van-col span="8">
            <div class="grid-item">
              <div class="icon">
                <img src="../assets/txsp/icon-1.png" />
              </div>
              <div class="text">广告特权</div>
            </div>
          </van-col>
          <van-col span="8">
            <div class="grid-item">
              <div class="icon">
                <img src="../assets/txsp/icon-2.png" />
              </div>
              <div class="text">下载特权</div>
            </div>
          </van-col>
          <van-col span="8">
            <div class="grid-item">
              <div class="icon">
                <img src="../assets/txsp/icon-3.png" />
              </div>
              <div class="text">角色弹幕</div>
            </div>
          </van-col>
          <van-col span="8">
            <div class="grid-item">
              <div class="icon">
                <img src="../assets/txsp/icon-4.png" />
              </div>
              <div class="text">杜比视听</div>
            </div>
          </van-col>
          <van-col span="8">
            <div class="grid-item">
              <div class="icon">
                <img src="../assets/txsp/icon-5.png" />
              </div>
              <div class="text">畅享蓝光</div>
            </div>
          </van-col>
          <van-col span="8">
            <div class="grid-item">
              <div class="icon">
                <img src="../assets/txsp/icon-6.png" />
              </div>
              <div class="text">漫画特权</div>
            </div>
          </van-col>
        </van-row>
        <ul class="rule-style">
          ...
          <li>
            <div class="rule-title">二、活动主题</div>
            <div class="text-subtitle">腾讯视频观影月</div>
          </li>
          <li>
            <div class="rule-title">三、活动对象</div>
            <div class="text-subtitle">中国工商银行手机银行实名客户</div>
          </li>
          <li>
            <div class="rule-title">四、活动内容</div>
          ...
          <li>
            ...
            <div class="text">
              如有疑问，请咨询深圳市盛宇信达企业管理咨询有限公司，客服电话：400-8762568（人工服务时间：9:00-18:00）或致电95588客服电话进行咨询。
            </div>
...
import { queryCommodity } from "@/api/index";
